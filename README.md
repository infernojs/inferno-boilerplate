...
This is a very basic boilerplate example for people wanting to get started with Inferno. This boilerplate uses `inferno@beta31`, `webpack`, `babel` and the `babel-plugin-inferno` JSX Babel plugin.
